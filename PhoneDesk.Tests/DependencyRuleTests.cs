...
namespace PhoneDesk.Tests
{
    ...
    public class DependencyRuleTests
    {
        ...
        public void Domain_assembly_has_no_framework_dependencies()
        {
            ...
            var domain = typeof(PhoneDesk.Services.ConstantsService).Assembly;
            Assert.Equal("PhoneDesk.Domain", domain.GetName().Name);
        ...
        public void Application_assembly_has_no_ui_or_io_framework_dependencies()
        {
            ...
            var application = typeof(PhoneDesk.Services.Interfaces.IPowerShellContextService).Assembly;
            Assert.Equal("PhoneDesk.Application", application.GetName().Name);
        ...
        public void Infrastructure_assembly_does_not_reference_ui_frameworks()
        {
            ...
            var infrastructure = typeof(PhoneDesk.Services.PowerShellContextService).Assembly;
            Assert.Equal("PhoneDesk.Infrastructure", infrastructure.GetName().Name);
        ...
        public void Presentation_assembly_does_not_reference_infrastructure_or_io_frameworks()
        {
            ...
            var presentation = typeof(PhoneDesk.ViewModels.MainWindowViewModel).Assembly;
            Assert.Equal("PhoneDesk.Presentation", presentation.GetName().Name);

            string[] forbidden =
            {
                "PhoneDesk.Infrastructure",
                "System.Management.Automation",
                "Microsoft.PowerShell",
                "Microsoft.Identity.Client",
            };
