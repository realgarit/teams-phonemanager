...
public sealed class UpdateServicesTests
{
    ...
    public async Task CheckForUpdateAsync_ReleaseHasDigest_ReturnsVerifiedInstallerMetadata()
    {
        ...
        var json = $$"""
            {
              "tag_name": "v2.0.0",
              "html_url": "https://github.com/realgarit/phonedesk/releases/tag/v2.0.0",
              "assets": [
                {
                  "name": "phonedesk-win-x64-setup.exe",
                  "browser_download_url": "https://github.com/realgarit/phonedesk/releases/download/v2.0.0/phonedesk-win-x64-setup.exe",
    ...
    public async Task DownloadInstallerAsync_ValidDigest_ReturnsVerifiedFile()
    {
        ...
        var asset = new UpdateAsset(
            ...
            "https://github.com/realgarit/phonedesk/releases/download/v2.0.0/phonedesk-win-x64-setup.exe",
            digest);
